...
import { PieChart, Pie, Cell, ResponsiveContainer, Legend, Tooltip as RechartsTooltip, XAxis, YAxis, CartesianGrid, Area, AreaChart, BarChart, Bar } from "recharts";
    ...
    return Object.entries(grouped)
      .map(([name, value]) => {
        ...
        return {
          name,
          value,
          color: category?.color || getColorForString(name),
        };
      })
