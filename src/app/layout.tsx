...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.className} antialiased bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 min-h-screen overflow-x-hidden`}>
        <Providers>
          <div className="flex flex-col md:flex-row min-h-screen">
            ...
            <main className="flex-1 w-full overflow-x-hidden">
              ...
              <div className="fixed inset-0 overflow-hidden pointer-events-none md:hidden">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-500/5 via-purple-500/5 to-pink-500/5" />
              </div>
              
              <div className="relative z-10 p-4 sm:p-6 md:p-10 max-w-full md:max-w-7xl mx-auto">
                {children}
              </div>
            </main>
          </div>
